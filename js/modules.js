        ...
        var moonreadNative = self.parsePreset({
            ...
            prompts: [
                ...
                },
                {
                    ...
                    injection_depth: 1,
                    injection_order: 3,
                    content: '【世界运转规则】\n世界是活的——NPC有自己的日程和动机，不会围着主角转。因果关系真实存在：行动有后果，秘密会暴露，信任需要时间建立。\n\n【叙事工具】\n- 每回合穿插 2-5 个 <giggle>角色名：真实想法</giggle> 心声——他们是没说出口的话，让场景有温度\n- 用 <mem> 主动标记状态变化（事件/任务/角色字段/物品/地点），让记忆系统精准记录\n- 长章节或情绪大转折用 [章节结束|标题] 给玩家呼吸点\n- 朋友圈/邮件/论坛/商店/日记等世界模块在合适的剧情节点自然出现\n\n【叙事节奏】\n- 场景转换时给出环境描写，让读者"到达"新地点\n- 对话中穿插动作和内心，避免纯对话流\n- 紧张时刻用短句加速，平静时刻用长句铺陈\n- 每段叙事至少包含一个感官细节'
                }
            ],
            use_sysprompt: true,
            temperature: 1.0,
        ...
        var fruitNative = self.parsePreset({
            ...
            prompts: [
                ...
                },
                {
                    ...
                    injection_depth: 4,
                    injection_order: 3,
                    content: '【叙事原则】\n- 角色行为符合其性格和动机，不为了剧情需要而OOC\n- 世界对角色的行动有真实的反馈\n- 每回合穿插 2-5 个 <giggle>心声（口是心非/潜台词/旁观者吐槽），用<mem>标记所有状态变化\n- 关系变化时记得更新 characters 数组的 favorability 字段\n- 长章节用 [章节结束|标题] 收尾\n- 选项(choices)让玩家感到自己在推动故事，而不是在选ABCD'
                }
            ],
            use_sysprompt: true,
