    ...
    getStrictSchema() {
        return {
            ...
            properties: {
                ...
                gameTime: {
                    type: 'object',
                    description: '游戏内时间（非现实时间）。必须根据本回合剧情活动量合理推进时间。重要：剧情需要时间发展——简单对话推进15-30分钟，正式交谈/教学推进1-2小时，短途移动推进30分钟-1小时，学习/训练/工作/修炼推进半天-一整天，睡眠/过夜推进到次日（date+1），多日旅行推进数日（date+N），闭关/修炼突破/康复推进数周-数月。绝对不能在几千字的丰富剧情后只推进几分钟。如果story提到"第二天""数天后""数月后"等，date/time必须相应跳转',
                    properties: {
