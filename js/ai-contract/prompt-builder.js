...
var _TIME_PROGRESSION_RULES =
    ...
    '\n' +
    '时间消耗参考表（必须严格遵守）：\n' +
    '  · 简短对话/观察/思考：推进15～30分钟\n' +
    '  · 正式交谈/谈判/教学/长对话：推进1～2小时\n' +
    '  · 短途移动（同区域内移动）：推进30分钟～1小时\n' +
    '  · 长途旅行/探索大型区域：推进数小时～半天\n' +
    '  · 学习/训练/工作/修炼：推进半天～一整天\n' +
    '  · 休息/睡眠/过夜：推进到次日（date+1，time重置为07:00清晨）\n' +
    '  · 多日旅行/长途跋涉：推进数日（date+N）\n' +
    '  · 时间跳跃（修炼突破/康复/等待/闭关）：推进数周～数月（date+30~90）\n' +
    '\n' +
    '活动密度规则（关键！）：\n' +
    '  · 如果本回合故事超过1000字且包含多项活动，时间必须推进至少1～2小时\n' +
    '  · 如果故事中角色去了多个地方（场景转换2次以上），时间必须推进至少2～3小时\n' +
    '  · 如果故事包含学习/训练/工作/探索等耗时活动，时间必须推进至少半天\n' +
    ...
    '  7. 在story正文中适当提及时间流逝（如"不知不觉已是黄昏""两个时辰后"），让时间推进有叙事依据\n' +
    '\n' +
    '示例：\n' +
    '  · 去图书馆查阅资料 → time从10:00推进到12:00（2小时），period变为"中午"\n' +
    '  · 在图书馆读到闭馆后回宿舍睡觉 → date+1，time变为"07:00"，period变为"清晨"\n' +
    '  · 与导师长谈后去训练场练习 → time从09:00推进到15:00（6小时），period变为"下午"\n' +
    '  · 闭关修炼三天 → date+3，time变为"08:00"，period变为"上午"\n' +
    '  · 花了一整天探索遗迹 → time从08:00推进到18:00，period变为"傍晚"\n' +
    '  · 等待数月后收到回信 → date+90，time变为"10:00"，period变为"上午"';
