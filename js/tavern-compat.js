    ...
    */
    ...
    renderInjectionPreview: function(em) {
        ...
        var html = '<div class="memory-card">'
            ...
            + '<div style="font-size:12px;color:var(--text-tertiary);">永久事实</div>'
            + '<div style="font-size:15px;font-weight:600;">' + (mc.worldAnchors || 0) + '字</div>'
            + '</div>'
            + '<div style="padding:10px;background:var(--bg);border-radius:8px;text-align:center;">'
            + '<div style="font-size:12px;color:var(--text-tertiary);">约定</div>'
            + '<div style="font-size:15px;font-weight:600;">' + (mc.activeQuests || 0) + '字</div>'
            + '</div>'
            + '<div style="padding:10px;background:var(--bg);border-radius:8px;text-align:center;">'
            + '<div style="font-size:12px;color:var(--text-tertiary);">剧情</div>'
            + '<div style="font-size:15px;font-weight:600;">' + (mc.currentPlot || 0) + '字</div>'
            + '</div>'
            + '<div style="padding:10px;background:var(--bg);border-radius:8px;text-align:center;">'
            + '<div style="font-size:12px;color:var(--text-tertiary);">角色</div>'
            + '<div style="font-size:15px;font-weight:600;">' + (mc.characters || 0) + '字</div>'
            + '</div>'
            + '<div style="padding:10px;background:var(--bg);border-radius:8px;text-align:center;">'
            + '<div style="font-size:12px;color:var(--text-tertiary);">事件</div>'
            + '<div style="font-size:15px;font-weight:600;">' + (mc.events || 0) + '字</div>'
            + '</div>'
            + '<div style="padding:10px;background:var(--bg);border-radius:8px;text-align:center;">'
            + '<div style="font-size:12px;color:var(--text-tertiary);">物品</div>'
            + '<div style="font-size:15px;font-weight:600;">' + (mc.items || 0) + '字</div>'
            + '</div>'
            + '<div style="padding:10px;background:var(--bg);border-radius:8px;text-align:center;">'
            + '<div style="font-size:12px;color:var(--text-tertiary);">最近对话</div>'
            + '<div style="font-size:15px;font-weight:600;">' + (mc.workingMemory || 0) + '字</div>'
            + '</div>'
            + '<div style="padding:10px;background:var(--bg);border-radius:8px;text-align:center;">'
            + '<div style="font-size:12px;color:var(--text-tertiary);">剩余预算</div>'
            + '<div style="font-size:15px;font-weight:600;">' + Math.max(0, stats.budget - stats.totalChars) + '字</div>'
            + '</div>'
            + '</div>'
...
MemoryManagerUI.renderAnchors = function(em) {
    ...
    typeOrder.forEach(function(t) {
        ...
        list.forEach(function(entry) {
            ...
            html += '<div style="padding:12px 14px;background:var(--bg);border-radius:8px;margin-bottom:8px;display:flex;justify-content:space-between;align-items:flex-start;gap:10px;">'
                + '<div style="flex:1;font-size:14px;line-height:1.7;word-break:break-all;">' + self._esc(a.content) + sourceTag + '</div>'
                + '<div style="display:flex;gap:6px;flex-shrink:0;">'
                + '<button onclick="MemoryManagerUI.editWorldAnchor(' + i + ')" style="font-size:12px;color:var(--accent);background:none;border:1px solid var(--border);padding:4px 10px;border-radius:6px;cursor:pointer;">编辑</button>'
                + '<button onclick="MemoryManagerUI.deleteWorldAnchor(' + i + ')" style="font-size:12px;color:#f44;background:none;border:1px solid var(--border);padding:4px 10px;border-radius:6px;cursor:pointer;">删除</button>'
                + '</div>'
                + '</div>';
        });
        html += '</div>';
