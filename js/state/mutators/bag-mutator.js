...
const BagMutator = {
    ...
    // 【纯 AI 驱动】已移除 extractItemsFromStory / _isInvalidItemName（本地正则从剧情提取物品）。
    // 该机制用"数量+单位+名词"、"获得/捡到 XX"等模式猜测拾取，把大量剧情叙述误判为物品
    // （如"露出一个笑容"→"一个笑容"入包），产生垃圾数据。背包 100% 由 AI 的 bag 字段驱动。
